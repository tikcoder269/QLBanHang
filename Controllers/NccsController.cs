...
namespace QLBH.Controllers
{
    public class NccsController : Controller
    {
        ...
        public NccsController(QuanLyBanHangContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MaNcc,TenNcc,DiaChiNcc,QuocGia,SoDt")] Ncc ncc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaNcc,TenNcc,DiaChiNcc,QuocGia,SoDt")] Ncc ncc)
        {
            if (id != ncc.MaNcc)
            {
                return NotFound();
